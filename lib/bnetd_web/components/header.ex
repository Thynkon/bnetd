defmodule BnetdWeb.Components.Header do
  ...
  def header(assigns) do
    ...
    <div class="w-1/2 pl-2 md:pl-0">
      <a class="text-gray-900 text-base xl:text-xl no-underline hover:no-underline font-bold" href="#">BNETD</a>
    </div>
        ...
        <div class="relative text-sm">
          ...
          <div id="userMenu" class="bg-white rounded shadow-md mt-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30 invisible">
            <ul class="list-reset">
              ...
              <li>
                <a href="#" class="px-4 py-2 block text-gray-900 hover:bg-gray-400 no-underline hover:no-underline">Admin</a>
              </li>
              <li>
      ...
      <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
        ...
        <li class="mr-6 my-2 md:my-0">
          <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-pink-500">
            <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Network traffic</span>
          </a>
        </li>
        <li class="mr-6 my-2 md:my-0">
            <i class="fa fa-envelope fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Bans</span>
        </li>
      </ul>
